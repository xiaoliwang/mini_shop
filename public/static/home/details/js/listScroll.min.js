!function (e) {
    ...
    e.fn.perfectScrollbar = function (n, i) {
        return this.each(function () {
            ...
            function S() {
                d(), y(), p(), f(), w(), m(), b(), (oe || ne) && T(oe, ne), P.useKeyboard && h(), M.data("perfect-scrollbar", M), M.data("perfect-scrollbar-update", d), M.data("perfect-scrollbar-destroy", L)
            }
            ...
            var E, D, C, Y, X, k, W, I, O, R, j, A, B = "rtl" === M.css("direction"), K = r(),
                ...
                $ = Z ? null : t(G.css("left")), ee = t(G.css("borderTopWidth")) + t(G.css("borderBottomWidth")),
                te = t(G.css("marginTop")) + t(G.css("marginBottom")),
                oe = "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch,
                ne = null !== window.navigator.msMaxTouchPoints;
            return S(), M
        })
    }
});